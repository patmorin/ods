...
@SuppressWarnings("unchecked") public class ReplaceAll {
    static final int SIZE = 20;

    public static void main(String[] args) throws Exception {
        List a[] = {new ArrayList(), new LinkedList(), new Vector(),
		    new ods.ArrayDeque(Object.class),
		    new ArrayStack(Object.class),
		    new SkiplistList(),
		    new FastArrayStack(Object.class),
		    new DLList(),
		    new SEList(5, Object.class),
		    new SEListRaw(5, Object.class),
		    new DualArrayDeque(Object.class),
		    new RootishArrayStack(Object.class),
		    new DualRootishArrayDeque(Object.class)};
