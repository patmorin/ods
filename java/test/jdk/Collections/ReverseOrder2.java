...
public class ReverseOrder2 {
	...
	test(new ods.ArrayDeque<String>(String.class));
	test(new ArrayStack<String>(String.class));
	test(new SkiplistList<String>());
	test(new FastArrayStack<String>(String.class));
	test(new DLList<String>());
	test(new SEList<String>(5, String.class));
	test(new SEListRaw<String>(5, String.class));
	test(new DualArrayDeque<String>(String.class));
	test(new RootishArrayStack<String>(String.class));
	test(new DualRootishArrayDeque<String>(String.class));
        test2(new ArrayList<Integer>());
        test2(new LinkedList<Integer>());
	test2(new ods.ArrayDeque<Integer>(Integer.class));
	test2(new ArrayStack<Integer>(Integer.class));
	test2(new SkiplistList<Integer>());
	test2(new FastArrayStack<Integer>(Integer.class));
	test2(new DLList<Integer>());
	test2(new SEList<Integer>(5, Integer.class));
	test2(new SEListRaw<Integer>(5, Integer.class));
	test2(new DualArrayDeque<Integer>(Integer.class));
	test2(new RootishArrayStack<Integer>(Integer.class));
	test2(new DualRootishArrayDeque<Integer>(Integer.class));
    }
