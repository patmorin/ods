...
public class IteratorAtEnd {
    ...
    static void realMain(String[] args) throws Throwable {
        ...
        testCollection(new java.util.ArrayDeque());
	...
	testCollection(new ods.ArrayDeque(Object.class));
	testCollection(new ArrayStack(Object.class));
	testCollection(new SkiplistList());
	testCollection(new FastArrayStack(Object.class));
	testCollection(new DLList());
	testCollection(new SEList(5, Object.class));
	testCollection(new SEListRaw(5, Object.class));
	testCollection(new DualArrayDeque(Object.class));
	testCollection(new RootishArrayStack(Object.class));
	testCollection(new DualRootishArrayDeque(Object.class));
	testCollection(new ArrayQueue(Object.class));
	testCollection(new SLList());
	// testCollection(new BinaryHeap(Object.class));
	testCollection(new SortedSSet(new SkiplistSet()));
	testCollection(new SortedSSet(new Treap()));
	testCollection(new SortedSSet(new BinarySearchTree(new SimpleBSTNode())));
	testCollection(new SortedSSet(new ScapegoatTree(new ScapegoatNode())));
	...
	testMap(new MultiplicativeHashMap());
    }
