...
public class MOAT {
    public static void realMain(String[] args) {
        ...
        testCollection(new java.util.ArrayDeque<Integer>());
	...
	testCollection(new ods.ArrayDeque<Integer>(Integer.class));
	testCollection(new ArrayStack<Integer>(Integer.class));
	testCollection(new SkiplistList<Integer>());
	testCollection(new FastArrayStack<Integer>(Integer.class));
	testCollection(new DLList<Integer>());
	testCollection(new SEList<Integer>(5, Integer.class));
	testCollection(new SEListRaw<Integer>(5, Integer.class));
	testCollection(new DualArrayDeque<Integer>(Integer.class));
	testCollection(new RootishArrayStack<Integer>(Integer.class));
	testCollection(new DualRootishArrayDeque<Integer>(Integer.class));
	testCollection(new ArrayQueue<Integer>(Integer.class));
	testCollection(new SLList<Integer>());
	testCollection(new BinaryHeap<Integer>(Integer.class));
	testCollection(new MultiplicativeHashSet<Integer>());
	testCollection(new SortedSSet<Integer>(new SkiplistSet<Integer>()));
	testCollection(new SortedSSet<Integer>(new Treap<Integer>()));
	testCollection(new SortedSSet<Integer>(new BinarySearchTree<SimpleBSTNode<Integer>,Integer>(new SimpleBSTNode<Integer>())));
	testCollection(new SortedSSet<Integer>(new ScapegoatTree<Integer>(new ScapegoatNode<Integer>())));
	testCollection(new HashTable<Integer>());
	...
	testMap(new MultiplicativeHashMap<Integer,Integer>());
