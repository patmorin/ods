...
The $O(\cdot)$ notation is not new or unique to computer science.
...
When studying data structure we tend to come across three different
kinds of running time guarantees:
...
and #SSet#, described in \secref{interfaces}.
