...
The preceding examples suggest that operations that require looking
...
\begin{figure}
  \centering{\includegraphics{figs/queue}}
...
\begin{figure}
  \centering{\includegraphics{figs/prioqueue}}
...
\begin{figure}
  \centering{\includegraphics{figs/stack}}
...
\begin{figure}
  \centering{\includegraphics{figs/list}}
...
\tabref{summary} summarizes the performance of data structures described
in this book that implement each of the interfaces, #List#, #USet#,
and #SSet#, described in \secref{interfaces}.  \Figref{dependencies}
...
\begin{exc}
  ...
  by the \javaonly{Java Collections Framework}\cpponly{C++ Standard
  Template Library}.
