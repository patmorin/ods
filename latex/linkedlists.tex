...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/sllist}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/dllist2}
  \end{center}
...
\begin{figure}
  ...
  \begin{center}
    \begin{tabular}{@{}l@{}}
      \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/selist-add-a}\\[4ex]
      \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/selist-add-b}\\[4ex]
      \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/selist-add-c}\\
    \end{tabular}
  \end{center}
