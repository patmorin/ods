...
The efficiency of skiplists relies on their use of \emph{randomization}.
...
skiplists is expressed in terms of \emph{expected} running times and path
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/skiplist}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/skiplist-searchpath}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/skiplist-add}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/skiplist-remove}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/skiplist-lengths}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/skiplist-addix}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/skiplist-removei}
  \end{center}
