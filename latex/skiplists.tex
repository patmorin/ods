...
#List# that has fast implementations of #get(i)#, #set(i,x)#, #add(i,x)#,
and #remove(i)#. We can also implement an #SSet# in which all operations
...
\begin{exc}
  Using the ideas from the space-efficient linked-list, #SEList#, design
