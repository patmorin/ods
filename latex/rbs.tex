...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/harmonic-2} 
        & \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/harmonic-3}
    \end{tabular}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/rbst-records}
  \end{center}
...
\begin{figure}
  \begin{center}
    \begin{tabular}{@{}c@{}}
      \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/rbst-probs-a} \\ (a) \\[2ex]
      \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/rbst-probs-b} \\ (b) \\[2ex]
    \end{tabular}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/treap}
  \end{center}
...
\begin{figure}
  \begin{center}
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/rotation}
  \end{center}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/treap-insert-a} \\
  \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/treap-insert-b} \\
  \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/treap-insert-c} \\
  \end{center}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/treap-delete-a} \\
  \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/treap-delete-b} \\
  \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/treap-delete-c} \\
  \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/treap-delete-d} 
  \end{center}
