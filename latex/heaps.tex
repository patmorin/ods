...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/heap-insert-1} \\
    \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/heap-insert-2} \\
    \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/heap-insert-3} \\
    \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/heap-insert-4} \\
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/heap-remove-1} \\
    \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/heap-remove-2} \\
    \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/heap-remove-3} \\
    \includegraphics[scale=0.90909,height=\QuarterHeightScaleIfNeeded]{figs/heap-remove-4} \\
  \end{center}
...
\begin{figure}
  \centering{\includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/meldable-merge}}
