...
\begin{exc}
  Imagine that the binary tree illustrated in \figref{eytzinger} is a
  #MeldableHeap#.  Illustrate the addition of the values 3.5 and then 2.5.
  Use a coin to simulate a random bit when needed.
\end{exc}

\begin{exc}
  Imagine that the binary tree illustrated in \figref{eytzinger} is
  a #MeldableHeap#.  Illustrate the removal of the next two values
  (0 and 1).  Use a coin to simulate a random bit when needed.
\end{exc}
...
\begin{exc}
  Show how, in a #BinaryHeap# or #MeldableHeap#, to find the second smallest value in constant time.
\end{exc}
