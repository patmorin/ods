...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/mergesort}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/mergesort-recursion}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/comparison-tree}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/comparison-tree-b}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/countingsort}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/radixsort}
  \end{center}
