...
\begin{proof}
  ...
  that any binary tree with $k$ leaves has a height of at least $\log k$.
...
\begin{exc}
  ...
  reverse sorted order and then reverses the array.  This last step could
  be avoided by defining a new #Comparator# that negates the results
  of the input #Comparator#, #c#.  Explain why this would not be a good
  optimization.  (Hint: Consider how many negations would needed to be
