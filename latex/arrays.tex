...
Ignoring the cost of the potential #resize()# operations, The #add(x)#
and #remove()# operations on an #ArrayQueue# clearly take constant time.
The cost of calls to the #resize()# operation can be accounted for
using the same argument used to analyze the #resize()# operation for
#ArrayStack#s.

\begin{thm}
  TODO: Come up with a good statement for theorems
\end{thm}
