...
\begin{exc}
  ...
  #Queue# in which the #remove()# operation removes an element chosen
  uniformly at random from all of the elements currently stored in
  the queue.  The #add(x)# and #remove()# operations should run in
  $O(1)$ time.
\end{exc}
