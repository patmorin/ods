...
\begin{exc}
  ...
  extra non-#null# value?  Discuss any consequences this non-#null# value
  might have on the Java Runtime Environment's memory manager.
\end{exc}
}
...
\begin{exc}
  ...
  \noindent Hint: Making this work is really all about how you implement
