...
\begin{figure}
  \centering{\includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/em}}
...
\begin{figure}
  \centering{\includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-1}}
...
\begin{figure}
  \centering{\includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-2}}
...
\begin{figure}
   \centering{\begin{tabular}{@{}l@{}}
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-split-1} \\[2ex]
     \multicolumn{1}{c}{#u.split()#} \\ 
     \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-split-2} \\
   \end{tabular}}
...
\begin{figure}
   \centering{\begin{tabular}{@{}l@{}}
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-add-1} \\[2ex]
     \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-add-2} \\[2ex]
     \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-add-3} 
   \end{tabular}}
...
\begin{figure}
   \centering{\begin{tabular}{@{}l@{}}
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-remove-full-1} \\[2ex]
     \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-remove-full-2} \\[2ex]
     \multicolumn{1}{c}{#merge(v,w)#} \\
     \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-remove-full-3} \\[2ex]
     \multicolumn{1}{c}{#shiftLR(w,v)#} \\
     \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-remove-full-4} \\[2ex]
   \end{tabular}}
...
\begin{figure}
   \centering{\begin{tabular}{@{}l@{}}
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-remove-1} \\[2ex]
     \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
     \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-remove-2} 
   \end{tabular}}
...
\item[Borrowing:] If #w# has a sibling, #v#, with more than $B-1$ keys,
  ...
  \begin{figure}
      \centering{\begin{tabular}{@{}l@{}}
       \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-borrow-1} \\[2ex]
       \multicolumn{1}{c}{#shiftRL(v,w)#} \\ 
       \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
       \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-borrow-2} \\
     \end{tabular}}
  ...
  \begin{figure}
     \centering{\begin{tabular}{@{}l@{}}
       \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-merge-1} \\[2ex]
       \multicolumn{1}{c}{#merge(v,w)#} \\ 
       \multicolumn{1}{c}{$\Downarrow$} \\[2ex]
       \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/btree-merge-2} \\
     \end{tabular}}
...
\begin{figure}
  \centering{\includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/bplustree}} 
