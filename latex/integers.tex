...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/binarytrie-ex-1}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/binarytrie-ex-2}
  \end{center}
...
either to smallest leaf larger than #x# or the largest leaf smaller than
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/binarytrie-ex-3}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/binarytrie-add}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/yfast-sample}
  \end{center}
