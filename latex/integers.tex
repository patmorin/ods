...
\begin{figure}
  ...
  \end{center}
  \caption{A #YFastTrie# containing the values 0, 1, 3, 4, 6, 8, 9, 10,
  11, and 13.}
  \figlabel{yfast}
\end{figure}
...
\begin{figure}
  ...
  \end{center}
  \caption{Adding the values 2 and 6 to a #YFastTrie#. The coin toss
...
\begin{figure}
  ...
  \end{center}
  \caption{Removing the values 1 and 9 from a #YFastTrie# in \figref{yfast-add}.}
...
\begin{figure}
  ...
  \end{center}
  \caption{The number of elements in the treap, #t#, containing #x#
...
\begin{exc}
  ...
  that doesn't use a binary trie at all. Instead, you implementation
