...
In this case, an integer \emph{hash code} is associated with each data
...
#t[i]#: \codeimport{ods/ChainedHashTable.add(x)} Growing the table,
...
Bibliography on Hashing \cite{hashing} contains nearly 2000 entries.
