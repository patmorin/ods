...
\begin{exc}
  Consider the multiplicative hashing scheme in \secref{multihash}, and
  suppose $#n#=2^{#d#}$ and $#d#\le #w#/2$.
  \begin{enumerate}
...
\begin{exc}
  ...
  even-indexed characters. Explain why this was a very bad idea by Giving
  an example of large set of strings that all have the same hash code.
\end{exc}
