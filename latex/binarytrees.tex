...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/bintree-1} &
      \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/bintree-2} \\
      (a) & (b)
    \end{tabular}
  \end{center}
...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
    \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/bst-example-2} &
    \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/bst-example-3} \\
    (a) & (b)
    \end{tabular}
  \end{center}
...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
    \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/bst-example-4} &
    \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/bst-example-5} 
    \end{tabular}
  \end{center}
...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
    \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/bst-delete-1}
    \includegraphics[scale=0.90909,width=\HalfScaleIfNeeded]{figs/bst-delete-2}
    \end{tabular}
  \end{center}
