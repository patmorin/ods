...
#n#)$ de tempo. No \chapref{rbs} mostramos como operações com $O(\log #n#)$ de tempo 
...
No \chapref{redblack} mostramos como operações que executam em $O(\log #n#)$ de tempo no \emph{pior caso} pode ser obtidas ao simular uma árvore que não é binária: uma árvore cujos nodos podem ter até quatro filhos.
