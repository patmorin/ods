...
\begin{thm}\thmlabel{redblacktree-amortized}
...
We will only sketch a proof of \thmlabel{redblack-amortized}. By comparing
...
from nodes.  \thmref{redblacktree-amortized} is a consequence of this
...
These original red-black trees 
