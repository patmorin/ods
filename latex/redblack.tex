...
\begin{figure}
  \begin{center}
   \begin{tabular}{c}
     \includegraphics[scale=0.90909,height=\FifthHeightScaleIfNeeded]{figs/24tree-remove-1} \\
     \includegraphics[scale=0.90909,height=\FifthHeightScaleIfNeeded]{figs/24tree-remove-2} \\
     \includegraphics[scale=0.90909,height=\FifthHeightScaleIfNeeded]{figs/24tree-remove-3} \\
     \includegraphics[scale=0.90909,height=\FifthHeightScaleIfNeeded]{figs/24tree-remove-4} \\
     \includegraphics[scale=0.90909,height=\FifthHeightScaleIfNeeded]{figs/24tree-remove-5} \\
   \end{tabular}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/flippullpush}
  \end{center}
...
\codeimport{ods/RedBlackTree.flipLeft(u)} The #flipLeft(u)# operation
...
\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,width=\ScaleIfNeeded]{figs/rb-addfix}
  \end{center}
...
to follow without referring to \figref{rb-removefix}.
Each iteration of the loop in #removeFixup(u)# processes the double-black
node #u#, based on one of four cases:

\begin{figure}
  \begin{center}
    \includegraphics[scale=0.90909,height=\HeightScaleIfNeeded]{figs/rb-removefix}
  \end{center}
